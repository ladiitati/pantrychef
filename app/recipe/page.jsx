const RecipeDetails = () => {
    return (
      <section className="bg-[#F4EDE2] p-8 rounded-2xl max-w-screen-lg mx-auto space-y-12">
        ...
        <div className="flex flex-col items-start justify-between md:flex-row md:items-center">
          ...
          <div className="space-y-4 md:w-1/2">
            ...
            <p className="font-medium text-gray-700 text-md">
              Health Rating : <span className="font-bold text-leaf-brown">91/100</span>
            </p>
  
            {/* Recipe Metrics */}
            <div className="flex mt-4 space-x-8">
              <div className="text-center">
                <p className="text-3xl font-light font-mulish text-leaf-brown">14</p>
                <p className="text-sm font-medium text-gray-600">Ingredients</p>
              </div>
              <div className="text-center">
                <p className="text-3xl font-light font-mulish text-leaf-brown">45</p>
                <p className="text-sm font-medium text-gray-600">Minutes</p>
              </div>
              <div className="text-center">
                <p className="text-3xl font-light font-mulish text-leaf-brown">1920</p>
            ...
            <div className="flex flex-wrap gap-2 mt-4">
              {["Lunch", "Dinner", "Main Course", "Desserts"].map((tag, index) => (
                <span
                  key={index}
        ...
        {/* Ingredients Section */}
        <div>
          <h2 className="mb-4 text-2xl font-bold text-leaf-brown">Ingredients</h2>
        ...
        <div>
          <h2 className="mb-4 text-2xl font-bold text-leaf-brown">Instructions</h2>
